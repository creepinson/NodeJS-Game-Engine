...
document.addEventListener("keydown", (e) =>
    ipcRenderer.send("keyboard", { code: e.keyCode, state: true })
);
document.addEventListener("keyup", (e) =>
    ipcRenderer.send("keyboard", { code: e.keyCode, state: false })
);
...
function ellipticalArc(x, y, rx, ry, a, s, e, c) {
    ctx.ellipse(x, y, rx, ry, a, s, e, c);
}
    ...
    switch (options.tag) {
        case "button":
            ...
            e.addEventListener("click", () =>
                ipcRenderer.send("element-click", { id: options.id })
            );
